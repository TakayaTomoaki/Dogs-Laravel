    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        <div class="card">
          ...
          <div class="card-body">
            <form action="{{ action('MypageController@store') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8">
                  <div class="form-check form-check-inline">
                    <input class="form-check-input ml-2" type="radio" name="dog_gender" value="0">
                    <label class="form-check-label">オス</label>
                    <input class="form-check-input ml-3" type="radio" name="dog_gender" value="1">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8">
                  <textarea class="form-control" name="dog_introduction" rows="5"></textarea>
                </div>
              </div>
              <div class="form-group row">
